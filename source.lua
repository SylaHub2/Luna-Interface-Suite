...
local Luna = { 
	Folder = "Luna", 
	Options = {}, 
	ThemeGradient = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(26, 195, 255)), ColorSequenceKeypoint.new(0.50, Color3.fromRGB(48, 93, 172)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(71, 134, 245))} 
}
...
local IconModule = {
	Lucide = nil,
	Material = {
		["discord"] = "http://www.roblox.com/asset/?id=73132811772878";
